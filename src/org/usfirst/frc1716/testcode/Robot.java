...
public class Robot extends IterativeRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        ...
        SmartDashboard.putNumber("Ratio Offset", 0.04);
        SmartDashboard.putNumber("Speed", -0.5);
        SmartDashboard.putNumber("Intake Speed", 0.5);
        SmartDashboard.putNumber("Gyro Sensitivity", 0.25);
        SmartDashboard.putNumber("Distance", 8);
        SmartDashboard.putNumber("Gyro Setpoint", -30);
        SmartDashboard.putNumber("Turn Speed", 0.25);
        SmartDashboard.putNumber("Distance 2", 1.0);
    }
